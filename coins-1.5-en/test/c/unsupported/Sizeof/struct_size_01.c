...
int main() {
	printf("%d,%d,%d,%d,%d,%d",
		sizeof(arrayUserInfo),   /*    976 */
		sizeof(arrayClass),      /*    576 */
		sizeof(arrayBasicType),  /*  39960 */
		sizeof(arrayArrays),     /*  66816 */
		sizeof(arrayCharArray),  /* 277380 */
		sizeof(arrayNestedStruct)); /* 280 */
