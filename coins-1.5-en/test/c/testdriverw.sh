...
##CLASS="coins.driver.Driver -S -b x86-cygwin -coins:preprocessor='cpp -I/usr/include',assembler=as" # CoinsCC compiler # if using java version older than java 1.6
CLASS="coins.driver.Driver -S -b x86-cygwin -coins:preprocessor='cpp-3 -I/usr/include'" # CoinsCC compiler default assembler=as
##CLASS="coins.driver.Driver -S -b x86-cygwin -coins:assembler=as" # CoinsCC compiler
##CLASS="coins.driver.Driver -S -b x86-cygwin -coins:hirOpt=loopexp/cf/cpf/dce/pre/gt,assembler=as" # CoinsCC compiler
##GCC="gcc -lm"         # GNU C compiler if using java version older than java 1.6
GCC="gcc-3 -lm"         # GNU C compiler
