/* tpcallFloat1.c:  Floating point arithmetic and calling sequence */
             ...
             int q1, int q2, int q3, int q4, int q5)
{
  ...
  printFloat2(p1, p2);
  printFloat2(p3, p4);
  k3 = fint(1, 10.0, 2, 15.0, 20, 40, 50, 60);
  return p1 + p2 + t1 + t2 + t3 + t4 + k3;
}
double float2(float p1, int pi1, float p2, float p3, float p4)
{
