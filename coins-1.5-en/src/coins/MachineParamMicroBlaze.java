...
--------------------------------------------------------------------- */
// MachineParamMicroBlaze.java
//                    //##10  Dec. 2001
package coins;

import coins.sym.Type;

/** MachineParamMicroBlaze class:
 *  Define target machine parameters and methods.
 *  The target machine is Intel x86.
**/
public class
MachineParamMicroBlaze extends MachineParam
{

public
MachineParamMicroBlaze( IoRoot pIoRoot )
{
  super(pIoRoot);
}

//====== Global Constants for MicroBlaze architecture ======//
...
evaluateSize( int pTypeKind )
{
    ...
    switch( pTypeKind ){
    case Type.KIND_BOOL:
      return MachineParamMicroBlaze.SIZEOF_BOOL;
    case Type.KIND_CHAR:
      return MachineParamMicroBlaze.SIZEOF_CHAR;
    case Type.KIND_WCHAR:                //##51
      return MachineParamMicroBlaze.SIZEOF_WCHAR;  //##51
    case Type.KIND_SHORT:
      return MachineParamMicroBlaze.SIZEOF_SHORT;
    case Type.KIND_INT:
      return MachineParamMicroBlaze.SIZEOF_INT;
    case Type.KIND_LONG:
      return MachineParamMicroBlaze.SIZEOF_LONG;
    case Type.KIND_FLOAT:
      return MachineParamMicroBlaze.SIZEOF_FLOAT;
    case Type.KIND_DOUBLE:
      return MachineParamMicroBlaze.SIZEOF_DOUBLE;
    case Type.KIND_LONG_DOUBLE:
      return MachineParamMicroBlaze.SIZEOF_LONG_DOUBLE;
    case Type.KIND_POINTER:
      return MachineParamMicroBlaze.SIZEOF_ADDRESS;
    ...
    case Type.KIND_U_LONG_LONG:
      return MachineParamMicroBlaze.SIZEOF_LONG_LONG;
    case Type.KIND_ADDRESS:
      return MachineParamMicroBlaze.SIZEOF_ADDRESS;
    case Type.KIND_OFFSET:
      return MachineParamMicroBlaze.SIZEOF_OFFSET;
    case Type.KIND_VOID:
    case Type.KIND_STRING:
    case Type.KIND_VECTOR:
    case Type.KIND_STRUCT:
...
**/
public boolean
isBigEndian() { return true; }  //##51

/** isLittleEndian: //##16
 *  @return true if little endian is selected, false otherwise.
**/
public boolean
isLittleEndian() { return false; } //##51
