...
public class TreeStructure
{
  ...
  /**
   * Constructs a new tree structure instance whose nodes are elements
   * of the specified argument <code>Collection</code>.
  ...
  /**
     * Returns the child nodes of the specified argument node
  ...
  public List childrenOf(Object pObj)
  {
    ...
    for (ListIterator lListIt = lNodes.listIterator();
         lListIt.hasNext(); ) {
  ...
  /**
   * Returns the ancestor nodes of the specified argument node,
   * including the argument node itself, in this tree structure.
   */
