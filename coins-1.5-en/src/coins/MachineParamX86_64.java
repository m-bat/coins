...
--------------------------------------------------------------------- */
// MachineParamX86_64.java
//                    //June 2007
package coins;

import coins.sym.Type;

/** MachineParamX86_64 class:
 *  Define target machine parameters and methods.
 *  The target machine is Intel x86_64.
**/
public class
MachineParamX86_64 extends MachineParam
{
...
//====== Global Constants for x86 64-bit version target ======//
...
evaluateSize( int pTypeKind )
{
    ...
    switch( pTypeKind ){
    case Type.KIND_BOOL:
      return MachineParamX86_64.SIZEOF_BOOL;
    case Type.KIND_CHAR:
      return MachineParamX86_64.SIZEOF_CHAR;
    case Type.KIND_WCHAR:                //##51
      return MachineParamX86_64.SIZEOF_WCHAR;  //##51
    case Type.KIND_SHORT:
      return MachineParamX86_64.SIZEOF_SHORT;
    case Type.KIND_INT:
      return MachineParamX86_64.SIZEOF_INT;
    case Type.KIND_LONG:
      return MachineParamX86_64.SIZEOF_LONG;
    case Type.KIND_FLOAT:
      return MachineParamX86_64.SIZEOF_FLOAT;
    case Type.KIND_DOUBLE:
      return MachineParamX86_64.SIZEOF_DOUBLE;
    case Type.KIND_LONG_DOUBLE:
      return MachineParamX86_64.SIZEOF_LONG_DOUBLE;
    case Type.KIND_POINTER:
      return MachineParamX86_64.SIZEOF_ADDRESS;
    ...
    case Type.KIND_U_LONG_LONG:
      return MachineParamX86_64.SIZEOF_LONG_LONG;
    case Type.KIND_ADDRESS:
      return MachineParamX86_64.SIZEOF_ADDRESS;
    case Type.KIND_OFFSET:
      return MachineParamX86_64.SIZEOF_OFFSET;
    case Type.KIND_VOID:
    case Type.KIND_STRING:
    case Type.KIND_VECTOR:
    case Type.KIND_STRUCT:
