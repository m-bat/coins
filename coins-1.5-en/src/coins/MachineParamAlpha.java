...
--------------------------------------------------------------------- */
// MachineParamAlpha.java
//                    // by T. Tsukamoto (UEC)
package coins;

import coins.sym.Type;

/** MachineParamAlpha class:
 *  Define target machine parameters and methods for Alpha architecture.
**/
public class
MachineParamAlpha extends MachineParam
{

public
MachineParamAlpha( IoRoot pIoRoot )
{
  super(pIoRoot);
}

//====== Global Constants for Alpha architecture ======//
...
//##88 public static final int
static final int  //##88
    // Alignment of basic types in allocation units.
//##34    ALIGN_BOOL       = 1,
    ALIGN_BOOL       = 8, // See SIZEOF_BOOL //##72
//  ALIGN_S_CHAR     = 1, //##9
    ALIGN_SHORT      = 2,
    ALIGN_INT        = 4,
    ALIGN_LONG       = 8, //##fnami //##72
 ...
 *      corresponding to pTypeKind in byte.
