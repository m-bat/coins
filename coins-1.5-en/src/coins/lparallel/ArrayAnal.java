...
*  ArrayAnal:
*  
* ref. ref. Parallelization domain analysis class.
*  
**/
class ArrayAnal {
    private HIR hir;
    ...
    *  
    **/
    ArrayAnal(HIR phir,LoopUtil pUtil)
    {
        hir = phir;
        fUtil = pUtil;
    }
    ...
    *  setLoopExitBBlock: 
    *
    *  ExitBBlock of a loop is set up.
    *  @param pBBlock   ExitBBlock (BasicBlock) 
    *
    **/
    ...
    *
    *  setRegOp: 
    *  A region operation class is setup.
    *
    *  @param pRegionOp     region opetarion 
    *
    **/
    ...
    *  getArrayList: 
    *
    *  Array which specifies a node and is contained in the tree is acquired.
    *
    *  ex)
    ...
    * make_ref_Array:
    *
    * ref_Array An object is generated.
    *
    *  @param node          HIR-node 
    *  @param IndList       induction-list 
    *  @param pInv          Invariant-object 
    *
    **/
    ...
    *   
    * ref_ArrayCellList  is generated.
    * 
    *  @param refList          ref-list 
    *  @param ArrayAnal        DDEF,EUSE ...       
    *
    **/
    ...
    *  get_refArrayCell:
    *   
    *  refArrayCell is acquired.
    * 
    *  @param varname          variave name 
    *  @param llist            RefArrayCell-list        
    **/
