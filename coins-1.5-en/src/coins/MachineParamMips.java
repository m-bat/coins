...
--------------------------------------------------------------------- */
// MachineParamMips.java
//
package coins;

import coins.sym.Type;

/** MachineParamMips class:
 *  Define target machine parameters and methods for MIPS architecture.
 *  Most items are the same to those of Sparc.
**/
public class
MachineParamMips extends MachineParam
{
...
//====== Global Constants for MIPS (same as SPARC version 8) ======//
...
//  SIZEOF_U_INT      = 4, //##9
//  SIZEOF_U_LONG     = 4, //##9
//  SIZEOF_U_LONG_LONG= 4, //##9 //##38 //2007.10
    SIZEOF_VOID       = 4, //##17
    SIZEOF_PTR        = 4,
    SIZEOF_ENUM       = 4,
    SIZEOF_ADDRESS    = 4,
...
//  ALIGN_U_INT      = 4, //##9
//  ALIGN_U_LONG     = 4, //##9
//  ALIGN_U_LONG_LONG= 4, //##9 //##38 //2007.10
    ALIGN_VOID       = 4, //##17
    ALIGN_PTR        = 4,
    ALIGN_ENUM       = 4,
    ALIGN_ADDRESS    = 4,
