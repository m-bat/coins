...
--------------------------------------------------------------------- */
// MachineParamSH4.java
//
package coins;

import coins.sym.Type;

/** MachineParamSH4 class:
 *  Define target machine parameters and methods for SH4 architecture.
 *  Most items are the same to those of Sparc but
 *  it is desirable to redefine them investigating whether they are correct or not.
**/
public class
MachineParamSH4 extends MachineParam
{

public
MachineParamSH4( IoRoot pIoRoot )
{
  super(pIoRoot);
}

//====== Global Constants for SH4 (same as SPARC version 8) ======//
