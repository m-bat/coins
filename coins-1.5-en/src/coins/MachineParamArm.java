...
--------------------------------------------------------------------- */
// MachineParamArm.java
//                    //##52  Oct. 2004
package coins;

import coins.sym.Type;

/** MachineParamArm class:
 *  Define target machine parameters and methods.
 *  The target machine is Arm Ver. 8.
**/
public class
MachineParamArm extends MachineParam
{

public
MachineParamArm( IoRoot pIoRoot )
{
  super(pIoRoot);
}

//====== Global Constants for ARM architecture ======//
...
static final int //##88
  ...
  // the value of basic type.
    SIZEOF_BOOL       = 4, //##14 (for C and Arm combination)
//  SIZEOF_S_CHAR     = 1, //##9
    SIZEOF_SHORT      = 2,
    SIZEOF_INT        = 4,
    SIZEOF_LONG       = 4, //##12
...
//  ALIGN_U_LONG_LONG= 8, //##9 //##38
    ...
    ALIGN_DOUBLE     = 8,
    ALIGN_LONG_DOUBLE= 8,
    ALIGN_STRUCT_MIN = 4, // Minimum alignment of struct/union. //##51
    ALIGN_REGION_MIN = 4, // Minimum alignment of Region.       //##51
...
getAlignment( int pTypeKind )
{
   ...
   * @return the allocation unit in addressing units.
   */
  public int
...
evaluateSize( int pTypeKind )
{
    ...
    switch( pTypeKind ){
    case Type.KIND_BOOL:
      return MachineParamArm.SIZEOF_BOOL;
    case Type.KIND_CHAR:
      return MachineParamArm.SIZEOF_CHAR;
    case Type.KIND_WCHAR:               //##51
      return MachineParamArm.SIZEOF_WCHAR; //##51
    case Type.KIND_SHORT:
      return MachineParamArm.SIZEOF_SHORT;
    case Type.KIND_INT:
      return MachineParamArm.SIZEOF_INT;
    case Type.KIND_LONG:
      return MachineParamArm.SIZEOF_LONG;
    case Type.KIND_FLOAT:
      return MachineParamArm.SIZEOF_FLOAT;
    case Type.KIND_DOUBLE:
      return MachineParamArm.SIZEOF_DOUBLE;
    case Type.KIND_LONG_DOUBLE:
      return MachineParamArm.SIZEOF_LONG_DOUBLE;
    case Type.KIND_POINTER:
      return MachineParamArm.SIZEOF_ADDRESS;
    ...
    case Type.KIND_U_LONG_LONG:
      return MachineParamArm.SIZEOF_LONG_LONG;
    case Type.KIND_ADDRESS:
      return MachineParamArm.SIZEOF_ADDRESS;
    case Type.KIND_OFFSET:
      return MachineParamArm.SIZEOF_OFFSET;
    case Type.KIND_VOID:
    case Type.KIND_STRING:
    case Type.KIND_VECTOR:
    case Type.KIND_STRUCT:
...
//    case Type.KIND_DEFINED:
    default:
      return MachineParam.SIZEOF_INT;
    }
} // evaluateSize
