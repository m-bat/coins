	...
	Cloneable
{
    ...
    private static HashMap<String,Integer> styleTypes = new HashMap<String,Integer>(20);

    private static HashMap<String,Stroke> strokeCache = new HashMap<String,Stroke>(4);
