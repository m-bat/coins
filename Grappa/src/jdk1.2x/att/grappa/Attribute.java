 ...
 * </TD>
 * </TR>
 * <TR><TD>BOX_TYPE</TD><TD>att.grappa.GrappaBox</TD></TR>
 ...
 * <TR><TD>LINE_TYPE</TD><TD>att.grappa.GrappaLine</TD></TR>
 * <TR><TD>POINT_TYPE</TD><TD>att.grappa.GrappaPoint</TD></TR>
 * <TR><TD>SHAPE_TYPE</TD><TD>java.lang.Integer (restricted)</TD></TR>
 * <TR><TD>SIZE_TYPE</TD><TD>att.grappa.GrappaSize</TD></TR>
 * <TR><TD>STRING_TYPE</TD><TD>java.lang.String (default)</TD></TR>
 * <TR><TD>STYLE_TYPE</TD><TD>att.grappa.GrappaStyle</TD></TR>
 * </TABLE>
 *
 ...
 */
public final class Attribute extends Object implements
	...
	public void addListener( IGrappaObjectListener listener ) {
		if( listeners == null ) {
			listeners = new ArrayList<IGrappaObjectListener>(3) ;
		}
	...
	public void notifyListeners(Object args) {
		if( listeners != null ) {
			for( IGrappaObjectListener listener : listeners ) {
	...
	public Object convertStringValue(int type, String name, String stringValue, int attrtype) {
		...
		if(stringValue == null || (stringValue != null && attrtype != STRING_TYPE && stringValue.trim().length() == 0)) {
			...
			case HASHMAP_TYPE:
				...
				if(this.value != null && this.value instanceof java.util.HashMap) {
