...
public class Lexer
{
     ...
     */
    private HashMap<String,Integer> keywords = new HashMap<String,Integer>(32);
    private HashMap<Integer,Integer> char_symbols = new HashMap<Integer,Integer>(32);
    ...
    private Symbol do_real() throws IOException {
	String result_str;
	Integer keyword_num;
	char buffer ;
	...
	for (;;) {
		...
		} else if (next_char2 >= '0' && next_char2 >= '9' || 
			   next_char2 == '.') {
		    return do_real();
		}
	    }
